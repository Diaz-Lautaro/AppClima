...
import backgroundImage from './img/clouds.jpg'; // Importa la imagen de nubes
...
export default function App() {
  ...
  const saveCityToDB = async (cityName) => {
    try {
      await axios.post('http://localhost:5000/cities', { name: cityName, timestamp: new Date().toISOString() });
    } catch (error) {
